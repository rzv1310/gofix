    ...
    <section className="relative overflow-hidden bg-secondary text-secondary-foreground">
      <div className="absolute inset-0 opacity-60">
        <picture>
          ...
          <img src={heroVanMobile} srcSet={`${heroVanM640} 640w, ${heroVanMobile} 941w`} sizes="100vw" alt="Autospecială GoFix de vulcanizare mobilă non-stop în Miroslava, Iași" width={1920} height={1080} fetchPriority="high" decoding="async" className="h-full w-full object-cover" />
        </picture>
...
export const Route = createFileRoute("/vulcanizare-mobila-miroslava")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava" },
      { property: "og:image", content: "https://vulcanizaremobila-iasi.ro/og-miroslava.jpg" },
      { property: "og:image:secure_url", content: "https://vulcanizaremobila-iasi.ro/og-miroslava.jpg" },
    ...
    links: [
      { rel: "canonical", href: "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              about: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#service" },
              primaryImageOfPage: {
                "@type": "ImageObject",
                url: "https://vulcanizaremobila-iasi.ro/gofix-logo-og.png",
              },
              breadcrumb: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#breadcrumb" },
              inLanguage: "ro-RO",
            },
            {
              "@type": "BreadcrumbList",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#breadcrumb",
              itemListElement: [
                {
                  "@type": "ListItem",
                  position: 1,
                  name: "Acasă",
                  item: "https://vulcanizaremobila-iasi.ro/",
                },
                {
                  "@type": "ListItem",
                  position: 2,
                  name: "Vulcanizare mobilă Miroslava",
                  item: "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/",
                },
              ],
            },
            {
              "@type": "Service",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#service",
              name: "Vulcanizare mobilă Miroslava",
              alternateName: [
              ...
              availableChannel: {
                ...
                serviceUrl: "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/",
              },
              hasOfferCatalog: {
                "@type": "OfferCatalog",
            ...
            {
              "@type": "FAQPage",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#faq",
              url: "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/",
              name: "Întrebări frecvente despre vulcanizare mobilă în Miroslava",
              isPartOf: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#webpage" },
              about: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-mobila-miroslava/#service" },
              inLanguage: "ro-RO",
