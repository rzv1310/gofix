...
export const Route = createFileRoute("/vulcanizare-pacurari")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://gofix.lovable.app/og-pacurari.jpg" },
      { property: "og:image:secure_url", content: "https://gofix.lovable.app/og-pacurari.jpg" },
      ...
      { name: "twitter:image", content: "https://gofix.lovable.app/og-pacurari.jpg" },
          ...
          "@graph": [
            {
              ...
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness",
              ...
              url: "https://gofix-vulcanizaremobila-iasi.ro/",
              logo: "https://gofix-vulcanizaremobila-iasi.ro/gofix-logo-og.png",
              image: "https://gofix-vulcanizaremobila-iasi.ro/gofix-logo-og.png",
            ...
            {
              "@type": "WebSite",
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/#website",
              url: "https://gofix-vulcanizaremobila-iasi.ro/",
              name: "GoFix Vulcanizare Mobilă Iași",
              publisher: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" },
              inLanguage: "ro-RO",
            },
            {
              "@type": "WebPage",
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#webpage",
              url: "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/",
              ...
              isPartOf: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#website" },
              about: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service" },
              primaryImageOfPage: { "@type": "ImageObject", url: "https://gofix-vulcanizaremobila-iasi.ro/gofix-logo-og.png" },
              breadcrumb: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#breadcrumb" },
              inLanguage: "ro-RO",
            },
            {
              "@type": "BreadcrumbList",
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#breadcrumb",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Acasă", item: "https://gofix-vulcanizaremobila-iasi.ro/" },
                { "@type": "ListItem", position: 2, name: "Vulcanizare Păcurari", item: "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/" },
              ],
            },
            {
              "@type": "Service",
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service",
              ...
              provider: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" },
              areaServed: [
                { "@type": "Place", name: "Păcurari", sameAs: "https://ro.wikipedia.org/wiki/P%C4%83curari", containedInPlace: { "@type": "City", name: "Iași" } },
                { "@type": "Place", name: "Canta", containedInPlace: { "@type": "City", name: "Iași" } },
                { "@type": "Place", name: "Moara de Foc", containedInPlace: { "@type": "City", name: "Iași" } },
              ...
              availableChannel: {
                ...
                serviceUrl: "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/",
              },
              hasOfferCatalog: {
                "@type": "OfferCatalog",
                name: "Servicii de vulcanizare în Păcurari",
                itemListElement: [
                  { "@type": "Offer", name: "Reparații pene cauciuc în Păcurari", itemOffered: { "@type": "Service", name: "Reparații pene cauciuc în Păcurari", serviceType: "Reparații anvelope", provider: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Schimb anvelope la domiciliu în Păcurari", itemOffered: { "@type": "Service", name: "Schimb anvelope la domiciliu în Păcurari", serviceType: "Schimb anvelope", provider: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Echilibrare roți în Păcurari", itemOffered: { "@type": "Service", name: "Echilibrare roți în Păcurari", serviceType: "Echilibrare roți", provider: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Vulcanizare pentru dube, camioane și tiruri în Păcurari", itemOffered: { "@type": "Service", name: "Vulcanizare pentru dube, camioane și tiruri în Păcurari", serviceType: "Vulcanizare vehicule comerciale", provider: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                ],
              },
            },
            {
              "@type": "FAQPage",
              "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#faq",
              url: "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/",
              name: "Întrebări frecvente despre vulcanizare în Păcurari",
              isPartOf: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#webpage" },
              about: { "@id": "https://gofix-vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service" },
              inLanguage: "ro-RO",
