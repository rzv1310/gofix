    ...
    <section className="relative overflow-hidden bg-secondary text-secondary-foreground">
      <div className="absolute inset-0 opacity-60">
        <picture>
          ...
          <img src={heroVanMobile} srcSet={`${heroVanM640} 640w, ${heroVanMobile} 941w`} sizes="100vw" alt="Autospecială GoFix de vulcanizare mobilă non-stop în Păcurari, Iași" width={1920} height={1080} fetchPriority="high" decoding="async" className="h-full w-full object-cover" />
        </picture>
        <div className="absolute inset-0 bg-gradient-to-r from-secondary via-secondary/70 to-secondary/40" />
      </div>
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:py-24">
        <div className="relative z-10">
          ...
          <h1 className="mt-5 font-display text-4xl leading-[0.95] text-white sm:text-5xl lg:text-7xl">
            GO<span className="text-primary">FIX</span> Vulcanizare Păcurari
          </h1>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 px-4 py-5 text-xs sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-4">
            <div className="flex gap-4">
              ...
              <Link to="/blog" className="hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded-sm">Blog</Link>
...
export const Route = createFileRoute("/vulcanizare-pacurari")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Vulcanizare Păcurari Iași Non-Stop | GoFix Vulcanizare Mobilă" },
      { property: "og:description", content: "Vulcanizare mobilă non-stop în Păcurari, Canta, Moara de Foc, Copou și Valea Lupului: pene, schimb anvelope și echilibrare roți pe loc." },
      { property: "og:url", content: "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari" },
      { property: "og:image", content: "https://vulcanizaremobila-iasi.ro/og-pacurari.jpg" },
      { property: "og:image:secure_url", content: "https://vulcanizaremobila-iasi.ro/og-pacurari.jpg" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "GoFix Vulcanizare Mobilă Păcurari Iași - autospecială GoFix, intervenții non-stop pentru pene, schimb anvelope și echilibrare roți la domiciliu." },
      ...
      { name: "twitter:description", content: "Intervenim în Păcurari, Canta, Moara de Foc, Copou, Valea Lupului pentru pene, schimb anvelope și echilibrare roți. Sună +40 332 630 507." },
    ...
    links: [
      { rel: "canonical", href: "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              "@type": "WebPage",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#webpage",
              url: "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/",
              name: "Vulcanizare Păcurari Iași | GoFix Vulcanizare Mobilă Non-Stop",
              description: "Ai făcut pană în Păcurari, Iași? GoFix vine la tine pentru vulcanizare mobilă, reparații pene, schimb anvelope și echilibrare roți pe loc.",
              isPartOf: { "@id": "https://vulcanizaremobila-iasi.ro/#website" },
              about: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service" },
              primaryImageOfPage: { "@type": "ImageObject", url: "https://vulcanizaremobila-iasi.ro/gofix-logo-og.png" },
              breadcrumb: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#breadcrumb" },
              inLanguage: "ro-RO",
            },
            {
              "@type": "BreadcrumbList",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#breadcrumb",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Acasă", item: "https://vulcanizaremobila-iasi.ro/" },
                { "@type": "ListItem", position: 2, name: "Vulcanizare Păcurari", item: "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/" },
              ],
            },
            {
              "@type": "Service",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service",
              name: "Vulcanizare Păcurari",
              alternateName: [
                "Vulcanizare mobilă Păcurari",
                "Reparații pene Păcurari",
                "Schimb anvelope Păcurari",
                "Echilibrare roți Păcurari",
              ],
              serviceType: "Vulcanizare mobilă",
              description: "Serviciu de vulcanizare mobilă în Păcurari, Iași, pentru reparații pene, schimb anvelope, echilibrare roți și intervenții pentru autoturisme, dube, autoutilitare, camioane și tiruri.",
              provider: { "@id": "https://vulcanizaremobila-iasi.ro/#localbusiness" },
              areaServed: [
                { "@type": "Place", name: "Păcurari", sameAs: "https://ro.wikipedia.org/wiki/P%C4%83curari", containedInPlace: { "@type": "City", name: "Iași" } },
                { "@type": "Place", name: "Canta", containedInPlace: { "@type": "City", name: "Iași" } },
                { "@type": "Place", name: "Moara de Foc", containedInPlace: { "@type": "City", name: "Iași" } },
                { "@type": "Place", name: "Valea Lupului", containedInPlace: { "@type": "AdministrativeArea", name: "Județul Iași" } },
                { "@type": "Place", name: "Rediu", containedInPlace: { "@type": "AdministrativeArea", name: "Județul Iași" } },
              ],
              availableChannel: {
                "@type": "ServiceChannel",
              ...
              hasOfferCatalog: {
                "@type": "OfferCatalog",
                name: "Servicii de vulcanizare în Păcurari",
                itemListElement: [
                  { "@type": "Offer", name: "Reparații pene cauciuc în Păcurari", itemOffered: { "@type": "Service", name: "Reparații pene cauciuc în Păcurari", serviceType: "Reparații anvelope", provider: { "@id": "https://vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Schimb anvelope la domiciliu în Păcurari", itemOffered: { "@type": "Service", name: "Schimb anvelope la domiciliu în Păcurari", serviceType: "Schimb anvelope", provider: { "@id": "https://vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Echilibrare roți în Păcurari", itemOffered: { "@type": "Service", name: "Echilibrare roți în Păcurari", serviceType: "Echilibrare roți", provider: { "@id": "https://vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                  { "@type": "Offer", name: "Vulcanizare pentru dube, camioane și tiruri în Păcurari", itemOffered: { "@type": "Service", name: "Vulcanizare pentru dube, camioane și tiruri în Păcurari", serviceType: "Vulcanizare vehicule comerciale", provider: { "@id": "https://vulcanizaremobila-iasi.ro/#localbusiness" }, areaServed: { "@type": "Place", name: "Păcurari" } } },
                ],
              },
            },
            {
              "@type": "FAQPage",
              "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#faq",
              url: "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/",
              name: "Întrebări frecvente despre vulcanizare în Păcurari",
              isPartOf: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#webpage" },
              about: { "@id": "https://vulcanizaremobila-iasi.ro/vulcanizare-pacurari/#service" },
              inLanguage: "ro-RO",
