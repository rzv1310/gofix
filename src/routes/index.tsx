...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vulcanizare mobilă Iași non-stop. Reparații pene, schimb anvelope și echilibrare roți la domiciliu, birou sau pe marginea drumului. Sună +40 332 630 507." },
      ...
      { property: "og:description", content: "Intervenim 24/7 în Iași și zona metropolitană pentru pene, schimb anvelope și echilibrare roți. Sună +40 332 630 507." },
      ...
      { property: "og:image:secure_url", content: "https://vulcanizaremobila-iasi.ro/og-home.jpg" },
      ...
      { name: "twitter:description", content: "Vulcanizare mobilă non-stop în Iași. Reparații pene, schimb anvelope și echilibrare roți la domiciliu. Sună +40 332 630 507." },
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pt-[42px] pb-16 sm:py-16 lg:py-24">
        <div className="relative z-10">
          ...
          <p className="mt-5 max-w-xl text-base text-secondary-foreground/80 sm:text-lg">
            Ai făcut pană în Iași sau împrejurimi? <span>Intervenim rapid la domiciliu</span>, la birou sau pe marginea drumului pentru reparații pene, schimb anvelope și echilibrare roți pe loc.
          </p>
    ...
    <footer id="contact" className="bg-black text-white/80">
      <div className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div>
          ...
          <ul className="mt-4 grid grid-cols-2 gap-x-4 gap-y-2 text-sm sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
