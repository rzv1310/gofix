    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          areaServed: [
            { "@type": "City", name: "Iași", addressCountry: "RO" },
            { "@type": "Place", name: "Copou", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/Copou" },
            { "@type": "Place", name: "Centrul istoric", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/Centru,_Ia%C8%99i" },
            { "@type": "Place", name: "Țicău", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/%C8%9Aic%C4%83u" },
            { "@type": "Place", name: "Tudor Vladimirescu", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/Tudor_Vladimirescu_%28cartier_din_Ia%C8%99i%29" },
            { "@type": "Place", name: "Tătărași", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/T%C4%83t%C4%83ra%C8%99i,_Ia%C8%99i" },
            { "@type": "Place", name: "Păcurari", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/P%C4%83curari" },
            { "@type": "Place", name: "C.U.G.", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/C.U.G." },
            { "@type": "Place", name: "Cantemir", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/Cantemir%2C_Ia%C8%99i" },
            { "@type": "Place", name: "Nicolina", containedInPlace: { "@type": "City", name: "Iași" }, sameAs: "https://ro.wikipedia.org/wiki/Nicolina%2C_Ia%C8%99i" },
            { "@type": "City", name: "Aroneanu", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Bârnova", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Ciurea", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Holboca", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Lețcani", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Miroslava", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Popricani", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Rediu", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Schitu Duca", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Tomești", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Ungheni", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Valea Lupului", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Victoria", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Comarna", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Costuleni", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Dobrovăț", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Golăiești", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Grajduri", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Mogoșești", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Movileni", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Prisăcani", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Românești", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Scânteia", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Țigănași", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Țuțora", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Voinești", containedInPlace: { "@type": "City", name: "Iași" } },
            { "@type": "City", name: "Horlești", containedInPlace: { "@type": "City", name: "Iași" } },
          ],
          address: {
            "@type": "PostalAddress",
...
function Vehicles() {
  const items = [
    ...
    { i: Truck, t: "Dube & autoutilitare", d: "Pentru curieri, transportatori, firme de distribuție și servicii locale." },
...
function BusinessSegment() {
  const items = [
    { i: GraduationCap, t: "Studenți & profesori" },
    { i: Zap, t: "Angajați din IT" },
    { i: Building2, t: "Birouri & companii" },
    { i: Hospital, t: "Instituții & spitale" },
    { i: Truck, t: "Flote auto locale" },
  ];
  return (
    <section className="py-20">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {items.map(({ i: I, t }) => (
            <div key={t} className="rounded-xl border border-border bg-card p-5 text-center transition hover:border-primary hover:shadow-card">
              <I className="mx-auto h-8 w-8 text-primary" />
              <p className="mt-3 font-display text-sm">{t}</p>
            </div>
          ))}
        </div>
    ...
    <section className="bg-secondary py-20 text-secondary-foreground">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href="#" className="inline-flex items-center gap-3 rounded-md border border-white/20 bg-black px-5 py-3 transition hover:border-primary">
  ...
  return (
    <section id="faq" className="py-20">
      <div className="mx-auto max-w-3xl px-4">
        <SectionHeading kicker="FAQ" title="Întrebări frecvente despre vulcanizarea mobilă în Iași" />
