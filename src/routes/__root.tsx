...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vulcanizare mobilă Iași non-stop. Reparații pene de cauciuc, schimb anvelope și echilibrare roți la domiciliu sau pe drum. Sună la 0332 630 508." },
      ...
      { property: "og:description", content: "Vulcanizare mobilă Iași non-stop. Reparații pene de cauciuc, schimb anvelope și echilibrare roți la domiciliu sau pe drum. Sună la 0332 630 508." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "GoFix Vulcanizare Mobilă Iași Non-Stop" },
      { name: "twitter:description", content: "Vulcanizare mobilă Iași non-stop. Reparații pene de cauciuc, schimb anvelope și echilibrare roți la domiciliu sau pe drum. Sună la 0332 630 508." },
